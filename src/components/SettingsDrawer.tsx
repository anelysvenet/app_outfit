      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 top-[calc(100%+0.4rem)] z-40 max-h-64 w-full overflow-y-auto rounded-3xl border border-ink/5 bg-[#b89570] p-2 shadow-lift backdrop-blur-xl"
          >
            {options.map((o) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-h-[90svh] sm:max-h-[100svh] sm:h-full sm:w-96 overflow-y-auto rounded-t-3xl sm:rounded-none sm:rounded-l-3xl bg-[#c4a882] shadow-lift"
      >
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-ink/8 bg-[#c4a882]/95 px-6 py-4 backdrop-blur">
